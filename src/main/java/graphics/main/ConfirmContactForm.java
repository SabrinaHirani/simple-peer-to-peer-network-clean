...
public class ConfirmContactForm extends JPanel implements FocusListener {
    ...
    public ConfirmContactForm() {
        ...
        JLabel info = new JLabel("Someone wants to talk to you!");
        info.setBounds(20, 15, 280, 25);
        info.setFont(new Font("Fira Sans", Font.PLAIN, 12));
        info.setForeground(Color.decode(App.COLOR_MARZIPAN));
        this.add(info);
